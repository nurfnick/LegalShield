...
```
```{r}
#spendTotals=D1("Total")
#salesTotals=D2("Grand Total")
lmSpendSales = lm(TotalX~totally, data = Q1)
#print(Q1)
plot(Q1$TotalX, Q1$totally, pch =16, col = "red")%>%
abline(lmSpendSales) #Create the linear regression
abline(lmSpendSales)
plot(lmSpendSales, pch = 16, col = "red")
summary(lmSpendSales)
